...
//			}
	...
	public Object showUsers(HttpServletRequest request){
		String departmentname = request.getParameter("departmentname");// 第几页
		int id = bDepartmentService.getDepartmentIdByName(departmentname);
		List<UserEntity> users = usSerService.getAllUserByDepartId(id);
		return users;
	} 
