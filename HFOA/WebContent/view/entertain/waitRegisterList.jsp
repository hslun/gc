...
<head>
  ...
  <script type="text/javascript">
    ...
    function loadGrid(data) {
      //汉化 datagrid 翻页
      $("#llbinfo").datagrid({
        url: '${pageContext.request.contextPath}/applyExpenses/searchTravelExpenses',
        method: 'post',
        queryParams: data,
        pageSize: 20,
        rownumbers: true,
    ...
    $(function () {
      ...
      $("#btn_ok").click(function () {
        var param = "travelExpenseId="+$("#travelExpenseId").textbox("getText").trim()+
  ...
  <table align="center" style="margin-top:20px;">
    ...
    <tr>
      ...
      <td><input id="vehicleCost"  name="needAdd" class="easyui-numberbox"
                 precision="2" value="0.00" type="text" style="width: 160px;" required="true"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input id="parValueAllowance" name="needAdd" class="easyui-numberbox"
                 precision="2" value="0.00" type="text" onclick="this.value='';focus()" style="width: 160px;" required="true"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input id="inputTax" name="needAdd" class="easyui-numberbox"
                 precision="2" value="" type="text" style="width: 160px;" required="true"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input id="voucherNum" class="easyui-textbox" style="width: 160px;" required="true"/></td>
    </tr>
    <tr>
