...
<body class="easyui-layout">
	...
	<div data-options="region:'west',split:true,title:'导航菜单'"
	    ...
	    <div title="业务招待明细" data-options="iconCls:'icon-baseinfo'" style="overflow:auto;"> <!-- overflow:auto高度随着页面的高底而延伸 -->
	...
	<!-- 	<div title="个人中心" data-options="iconCls:'icon-person'" style="overflow:auto;">
		 ...
		 -->
		 <div title="招待预算信息" data-options="iconCls:'icon-rz'" style="overflow:auto;"> <!-- overflow:auto高度随着页面的高底而延伸 -->
...
<!-- 		 <div title="公车使用信息" data-options="iconCls:'icon-rz'" style="overflow:auto;"> overflow:auto高度随着页面的高底而延伸 -->
<!-- 			<ul id="commonCar" class="easyui-tree" style="width: 100%;height:100%;">  -->
<!-- 			</ul> -->
<!-- 		</div> -->
		
<!-- 		 <div title="公章使用信息" data-options="iconCls:'icon-rz'" style="overflow:auto;"> overflow:auto高度随着页面的高底而延伸 -->
<!-- 			<ul id="officialSeal" class="easyui-tree" style="width: 100%;height:100%;">  -->
<!-- 			</ul> -->
<!-- 		</div> -->
		
<!-- 		 <div title="操作日志信息" data-options="iconCls:'icon-rz'" style="overflow:auto;"> overflow:auto高度随着页面的高底而延伸 -->
