...
<!-- 						data-options="field:'id',width:fixWidth(0.15),align:'center'">id</th> -->
				 	<th 
						data-options="field:'department',width:fixWidth(0.15),align:'center'">部门</th>
					<th
						data-options="field:'budgetSum',width:fixWidth(0.15),formatter:textbox,align:'center'">预算金额（万元）</th>
					<th
						data-options="field:'copileTime',width:fixWidth(0.15),formatter:copiletime,align:'center'">编制时间</th>
					<th
						data-options="field:'adjustSum',width:fixWidth(0.15),formatter:adjust,align:'center'">调整金额（万元）</th>
