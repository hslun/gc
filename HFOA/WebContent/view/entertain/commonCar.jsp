...
<script type="text/javascript">
	...
	$(function() {
		...
		loadGrid('${pageContext.request.contextPath}/CommonCar/display',null);
		// 确认按钮
		$("#btn_ok").click(
						function() {});
		// 取消按钮
...
// 											});
							$("#searchUser").dialog("close");
							loadGrid('${pageContext.request.contextPath}/CommonCar/searchInfoByPage',param);
						});
	...
	function exportExcel(){
			...
			window.open('${pageContext.request.contextPath}/CommonCar/exportExcel?number='+total);
		...
		<table id="llbinfo" class="easyui-datagrid" title="公车使用信息"
			...
			<thead>
				<tr>
					...
					<th
						data-options="field:'startAddress',width:fixWidth(0.1),align:'center'">出发地</th>
					<th
						data-options="field:'endAddress',width:fixWidth(0.1),align:'center'">目的地</th>
					<th
			...
			<div style="text-align: center;">
				<table style="margin: auto;" cellspacing="10">
					...
					<tr>
						...
						data-options="
							url:'${pageContext.request.contextPath}/CommonCar/carKind',
							method:'get',
							valueField:'id',
							textField:'kind',
							editable:false,
