...
// 							alert(param);
// 							$.post(
// 									"${pageContext.request.contextPath}/gz/wGetSearchInfo",
// 									param, function(result) {
// 										$("#searchUser").dialog("close");
// 												$("#llbinfo").datagrid("loadData", result);
// 											});
							$("#searchUser").dialog("close");
							loadGrid('${pageContext.request.contextPath}/GZManage/displaySearch',param);
						});
	...
	function exportExcel(){
			...
			window.open('${pageContext.request.contextPath}/GZManage/exportExcel?number='+total);
...
<body>	<!-- 审核登记对话框 -->
	...
	<div class="mdiv" style="width:100%;height:94%;">
		<table id="llbinfo" class="easyui-datagrid" title="公章使用信息"
			style="width: auto; height:100%;">
			<thead>
				<tr>
				 	<th
						data-options="field:'id',width:fixWidth(0.12),align:'center'">审批单号</th>
					<th 
			...
			<div style="text-align: center;">
				<table style="margin: auto;" cellspacing="10">
					...
					<tr>
						...
						<td><input id="sgztype" class="easyui-combobox" data-options="
							url:'${pageContext.request.contextPath}/gz/getType',
							method:'get',
							valueField:'id',
							textField:'gzkind',
							editable:false,
